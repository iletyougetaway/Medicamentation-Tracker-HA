...
Версия `0.7.3` включает серверную часть интеграции, управление лекарствами,
...
на сегодня, напоминание, последний приём и недельную историю по дням. Добавление
лекарства доступно при редактировании панели управления, а существующие лекарства
можно изменять из самой карточки.

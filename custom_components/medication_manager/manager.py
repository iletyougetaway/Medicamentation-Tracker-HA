...
from .models import Medication, MedicationManagerStoreData, MedicationReminder
...
class MedicationManager:
    ...
    async def _async_store_locked(self, data: MedicationManagerStoreData) -> None:
        ...
        try:
            ...
            raise MedicationManagerError("Medication Manager persistence failed") from err
